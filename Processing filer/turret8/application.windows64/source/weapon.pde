...
void plasmaBomb() {   // plasma bomb
  if (weaponAmmo[4] >=2 && cooldown<=0) {
    ...
    bullets.add(new bullet(3, turretX+barrelX, turretY+barrelY, angle+(random(accuracy*2))+accuracy*1, distCross*0.03, 160, 30, 400, 0.08*turretDamage, false));  // static diff angle
...
void sniperShoot() {
  if (weaponAmmo[5] >0 && cooldown<=0) {
    ...
    bullets.add(new bullet(5, turretX+barrelX, turretY+barrelY, angle+(random((-accuracy*1))+(accuracy*0.5)), 120, 500, 10, 600, 50*turretDamage, false));  // static diff angle
...
void  vaccumSphere() {
 ...
 if (weaponAmmo[4] >0 && cooldown<=0) {
    ...
    bullets.add(new bullet(13, turretX+barrelX, turretY+barrelY, angle+(random(accuracy*1))+accuracy*0.5, distCross*0.03, 40, 20, 200, 0.08*turretDamage, false));  // static diff angle
    if (accuracy> -20) { //    accuracyloss
      accuracy-=10;
    }
    // bullet1= new bullets(width/2, height, angle, 30, 40, 5);
