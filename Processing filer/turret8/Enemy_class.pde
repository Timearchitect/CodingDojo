...
class enemy {
  ...
  void typeDifference() {
    ...
    case 5: // fast fire
      ...
      break;
    case 6:   // rapid bullets


      break;
    case 7:            // rocket pod
      maxHealth*=0.5;  // x0.5 health
      health*=0.5;
    ...
    case 9:            // barrage enemy
      maxHealth*=4;  // x4 health
      health*=4;
      break;
    case 10:                          // seeking enemy 
      maxHealth*=2; // x2 health
      health*=2;

      break;
    case 11:         // bounce enemy
      maxHealth*=3; // x2 health
      health*=3;
  ...
  void update() {
    ...
    case 9:            // barrage enemy
      ...
      if (attackSpeed*5<attackTimer) {
         ...
         */
        if (this.x<turretX) {
          eBullets.add(new bullet(1, this.x, this.y, 0, 20, 60, 25, 100, 8, false)); // rocket
        } else {
          eBullets.add(new bullet(1, this.x, this.y, -180, 20, 60, 25, 100, 8, false)); // rocket
        }
